...
description: "Overview of the Obertauern 2026 workshop — a modular, hands-on introduction to machine learning and modern AI for interdisciplinary audiences, held in the Austrian Alps."
permalink: /courses/obertauern-2026/
sidebar:
...
Across four sessions, we build a conceptual arc from the foundations of supervised learning through to modern AI systems. Sessions are structured around short, student-led topics — participants engage with the material actively rather than passively.
...
➡️ **[Technical Topics Overview](/courses/obertauern-2026/technical/)**
...
- Work with structured data using `pandas` and `matplotlib`
- Train and evaluate simple models with `scikit-learn`
...
Interactive sessions in which participants use real code to explore how machine learning models behave — from visualising decision boundaries to experimenting with training processes and, in the final session, working with modern AI tools.
...
These are participant-led, discussion-based conversations that draw on the group's disciplinary diversity, with space for genuine debate and disciplinary breadth.
...
➡️ **[Societal Topics Overview](/courses/obertauern-2026/societal/)**
